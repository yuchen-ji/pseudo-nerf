    ...
    for idx, (imgs, poses, hwf, bound) in enumerate(test_loader):
        ...
        for epoch_id in range(pseudo_num + 1):
            ...
            if epoch_id+1 != pseudo_num+1:
                ...
                pseudo_pose = get_delta_pose_all(source_poses, device, num_poses=(epoch_id+1), pose_range=((epoch_id+1)*math.pi/50))
        ...
        # write psnr to file
        with open('./videos_4v_50v/psnr.txt','a') as f:
